...
#if MOTHERBOARD == 7 || MOTHERBOARD == 33 || MOTHERBOARD == 72
	#define MACHINE_NAME "Delta"
	#define FIRMWARE_URL "http://www.wasproject.it/"
	#define MSG_INFO_1L "Delta Wasp FW ver2.0"
	#define MSG_INFO_2L "WASP for DEAGOSTINI "
	#define MSG_INFO_3L " Rev.6.1-10/2016    "
#elif MOTHERBOARD == 80
