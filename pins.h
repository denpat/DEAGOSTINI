...
// #define RAMPS_V_1_0
  ...
  #define TEMP_BED_PIN       14   // ANALOG NUMBERING
    ...
    #ifdef NEWPANEL
      #define LCD_PINS_RS 16  // 27 //16
      #define LCD_PINS_ENABLE 17  //29 //17
      #define LCD_PINS_D4 23  //25 //23 
      #define LCD_PINS_D5 25  //23 //25
      #define LCD_PINS_D6 27  //16  //27
      #define LCD_PINS_D7 29  //17 //29
